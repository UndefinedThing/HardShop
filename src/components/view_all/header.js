            ...
            <header className="header header-sticky header-transparent">
                <div className="container">
                    ...
                    <nav className="navbar navbar-expand-lg navbar-dark">
                        <a href="../../index.html" className="navbar-brand"><img src="../../assets/images/logo-white.svg" alt="Logo" /></a>
                        ...
                        <ul className="navbar-nav mr-auto">
                            ...
                            <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle active" href="/" id="dropdown-2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Help Center
                            </a>
                            <div className="dropdown-menu" aria-labelledby="dropdown-2">
                                ...
                                <a className="dropdown-item active" href="../../html/help/homepage-2.html">Homepage 2</a>
                                ...
                                <a className="dropdown-item" href="../../html/help/category-inner.html">Category Inner</a>
                                <a className="dropdown-item" href="../../html/help/article-1.html">Article 1</a>
                                <a className="dropdown-item" href="../../html/help/article-2.html">Article 2</a>
                                <a className="dropdown-item" href="../../html/help/tutorial.html">Tutorial</a>
                            </div>
                            </li>
                            <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropdown-3">
                                <a className="dropdown-item" href="../../html/pages/contact.html">Contact</a>
                                <a className="dropdown-item" href="../../html/pages/changelog.html">Changelog</a>
                                <a className="dropdown-item" href="../../html/pages/faq.html">FAQ</a>
                                <a className="dropdown-item" href="../../html/pages/pricing.html">Pricing</a>
                                <a className="dropdown-item" href="../../html/pages/terms.html">Terms</a>
                                <div className="dropdown-divider" />
                                <a className="dropdown-item" href="../../html/pages/404.html">404</a>
                            </div>
                            </li>
                        </ul>
