...
>>>>>>> 8792d3a3bffafe31f584703ee2fb06628c99cf2c
              </div>
              <div className="row">
                <div className="col text-center">
                  ...
                  >
                    <div className="card card-showcase lift">
                      <a href="html/docs/layout-1.html">
                        <img
                          ...
                          src="assets/images/layout-1.png"
                          alt="Documentation Layout 1"
                        />
                      </a>
                    </div>
                    <div className="card card-showcase lift">
                      <a href="html/docs/layout-2.html">
                        <img
                          className="card-img-top"
                          src="assets/images/layout-2.png"
                          alt="Documentation Layout 2"
                        />
                      </a>
                    </div>
                    <div className="card card-showcase lift">
                    ...
                    <div className="card card-showcase lift">
                      <a href="html/docs/layout-4.html">
                        <img
                          className="card-img-top"
                          src="assets/images/layout-4.png"
                          alt="Documentation Layout 4"
                        />
                      </a>
                    </div>
                    <div className="card card-showcase lift">
          ...
          <section className="pt-0">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-md-6 text-center">
                  <h2>
                    <b>Highlight</b> what's important.
                  </h2>
                  <p>
                    We offer high ammount of different components to showcase
                ...
                <div className="col-lg-5">
                  ...
                  <div className="row mt-3 d-none d-lg-block">
                    <div className="col">
                      <div className="boxed p-3">
                        <ul className="file-tree">
                          <li className="file-tree-folder empty">
                            Images
                            <span>description</span>
                          </li>
                          ...
                          <li>
                            index.html <span>description</span>
                          </li>
                          <li>
                            components.html <span>description</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="cta boxed no-border bg-primary p-3 p-md-5">
                    ...
                    <div className="row">
                      <div className="col text-white">
                        <h2>
                          Next Level of <b>Documentation</b>
                        </h2>
                        <p className="lead">
                          Purchase Guidebook now, and make documenting your
                          project piece of cake.{" "}
                          <a href className="action text-white">
                            Buy Now
                          </a>
                        </p>
                      </div>
